- [基于 Gitlab-ci + Harbor 的 CI 流水线](https://blog.k8s.li/gitlab-ci-harbor.html)
...
![img](https://p.k8s.li/409-images-for-snap-blog-postedit_image1.png)
...
![img](https://p.k8s.li/409-images-for-snap-blog-postedit_image4-manual.png)
...
![img](https://p.k8s.li/409-images-for-snap-blog-postedit_image4-manual-1585574252795.png)
...
![img](https://p.k8s.li/20200326163733610.png)
...
![img](https://p.k8s.li/20200326170403918.png)

## 测试 CI/CD 项目

- 在 Gitlab 中使用 Spring 模板新建一个项目，并添加 `.gitlab-ci.yaml` 配置文件。

![img](https://p.k8s.li/20200326170523433.png)
...
![img](https://p.k8s.li/20200327102511419.png)

- 设置好相关变量之后在，在项目页面的 `CI/CD` —–> `流水线` 页面点击 `运行流水线`手动触发流水线任务进行测试。

![img](https://p.k8s.li/20200325163138089.png)

- 如果流水线任务构建成功的话，会显示 `已通过` 的表示

![img](https://p.k8s.li/20200325163254316.png)

- 登录到 Harbor http://10.10.107.217 查看镜像是否构建成功

![img](https://p.k8s.li/20200325163400519.png)
...
- [GitLab-CI使用Docker进行持续部署](http://zacksleo.top/2017/04/22/GitLab-CI使用Docker进行持续部署/)
