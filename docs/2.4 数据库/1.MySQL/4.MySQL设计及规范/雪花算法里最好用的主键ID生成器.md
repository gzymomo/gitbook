...
| 语言          | github                                                       | gitee                                                        |
| ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 🌲 C#          | [查看示例](https://github.com/yitter/idgenerator/tree/master/%23.NET) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/%23.NET) |
| 🌲 Java        | [查看示例](https://github.com/yitter/idgenerator/tree/master/Java) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/Java) |
| 🌲 Go          | [查看示例](https://github.com/yitter/idgenerator/tree/master/Go) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/Go) |
| 🌲 Rust        | [查看示例](https://github.com/yitter/idgenerator/tree/master/Rust) | [查看示例](https://gite.com/yitter/idgenerator/tree/master/Rust) |
| 🌲 C           | [查看示例](https://github.com/yitter/idgenerator/tree/master/C) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/C) |
| 🌲 C (PHP扩展) | [查看示例](https://github.com/yitter/idgenerator/tree/master/PHP) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/PHP) |
| 🌲 V           | [查看示例](https://github.com/yitter/idgenerator/tree/master/ZeOthers/Vlang) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/ZeOthers/Vlang) |
| 🌲 D           | [查看示例](https://github.com/yitter/idgenerator/tree/master/D) | [查看示例](https://gitee.com/yitter/idgenerator/tree/master/D) |

## 为什么不用大厂的？

❄ 首先，大厂们不但自己用雪花ID，而且还开源：[百度](https://github.com/baidu/uid-generator) | [美团](https://github.com/Meituan-Dianping/Leaf) | [滴滴](https://github.com/didi/tinyid) | [雪花ID鼻祖-推特](https://github.com/twitter-archive/snowflake)。
