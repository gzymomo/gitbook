- [FFmpeg 学习(五)：FFmpeg 编解码 API 分析](https://www.cnblogs.com/renhui/p/9328893.html)

在上一篇文章 [FFmpeg学习(四)：FFmpeg API 介绍与通用 API 分析](https://www.cnblogs.com/renhui/p/9293057.html) 中，我们简单的讲解了一下FFmpeg 的API基本概念，并分析了一下通用API，本文我们将分析 FFmpeg 在编解码时使用的API。
