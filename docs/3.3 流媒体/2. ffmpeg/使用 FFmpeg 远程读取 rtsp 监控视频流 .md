- [使用 FFmpeg 远程读取 rtsp 监控视频流](https://blog.k8s.li/ffmepg-rtsp.html)
...
![img](https://p.k8s.li/1561802376885.jpg)
...
![img](https://p.k8s.li/1561802376888.jpg)

![img](https://p.k8s.li/1561802376886.jpg.jpg)

找了半天最终还是找到了一个摄像头，价格也比较便宜😂。特意问了卖家能不能通过浏览器访问、能不能不需要专用的摄像机来访问摄像头。卖家说是可以的。

![img](https://p.k8s.li/1570702505815.png)

![img](https://p.k8s.li/1570702514509.png)

## 安装摄像头

把路由器的电源适配器输出接口给剪了，又接了一个 DC 2.5mm 的插头，这样一个电源适配器同时供路由器和摄像头使用了😂。不用担心功率，一个摄像头和路由器总功耗还不到 8W。

![img](https://p.k8s.li/1570704495847.png)

![img](https://p.k8s.li/1570702447664.png)

![img](https://p.k8s.li/1570702472108.png)

穹妹哦😂，骨科？

![img](https://p.k8s.li/1570702482302.png)

![img](https://p.k8s.li/1570702739896.png)

## 配置摄像头

询问卖家怎么配置摄像头，卖家说搜索雄迈，然后下载相应的工具。[配套软件下载 ](https://www.xiongmaitech.com/service/down_detail1/83/176) 下载安装就行。

![img](https://p.k8s.li/1570704765775.png)

![img](https://p.k8s.li/1570704813188.png)

![img](https://p.k8s.li/1570704875787.png)

![img](https://p.k8s.li/1570704956430.png)

![img](https://p.k8s.li/1570704990621.png)

![img](https://p.k8s.li/1570705020709.png)
...
![img](https://p.k8s.li/1570705646007.png)

![img](https://p.k8s.li/1570705720287.png)
